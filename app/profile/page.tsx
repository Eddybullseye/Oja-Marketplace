...
export default function ProfilePage() {
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-6 pb-24 md:pb-12 space-y-6">
      {/* Top Profile Banner */}
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <button type="button" onClick={() => fileInputRef.current?.click()} className="relative w-16 h-16 rounded-full group shrink-0">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-xl font-bold text-zinc-900 dark:text-zinc-50">{formData.firstName} {formData.lastName}</h1>
                <span className="inline-flex items-center gap-1 px-2.5 py-0.5 bg-emerald-50 text-emerald-800 dark:bg-emerald-950/20 dark:text-emerald-400 rounded-full text-[10px] font-semibold">
                  <ShieldCheck className="w-3 h-3" /> Verified Buyer
                </span>
              </div>
              <p className="text-xs text-zinc-500 dark:text-zinc-400">{formData.email} · Member since Jan 2026</p>
            </div>
          </div>

          {/* Quick Stats & Sign Out */}
          <div className="flex items-center gap-4 border-t md:border-t-0 md:border-l border-zinc-100 dark:border-zinc-800 pt-4 md:pt-0 md:pl-6">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="px-2 py-1 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800">
                <p className="text-[9px] uppercase tracking-wider font-bold text-zinc-400">Escrow</p>
                <p className="text-sm font-black text-emerald-600 dark:text-emerald-400">$190.00</p>
              </div>
              <div className="px-2 py-1 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800">
                <p className="text-[9px] uppercase tracking-wider font-bold text-zinc-400">Total Spent</p>
                <p className="text-sm font-bold text-zinc-900 dark:text-zinc-50">$1,420</p>
              </div>
              <div className="px-2 py-1 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800">
                <p className="text-[9px] uppercase tracking-wider font-bold text-zinc-400">Completed</p>
                <p className="text-sm font-bold text-zinc-900 dark:text-zinc-50">8 Jobs</p>
              </div>
            </div>
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1 no-scrollbar border-b border-zinc-200 dark:border-zinc-800">
        {sections.map((section) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 text-xs font-bold rounded-xl whitespace-nowrap transition-all ${isActive
